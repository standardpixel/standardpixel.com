...
I don't think anyone is being dishonest. I think they know what they need and they don't have a way to test for it, so they test for the thing that has a rubric. And the thing with a rubric tends to select for a different kind of engineer than the one they described in the first paragraph of the job post.

So the distinction hasn't gone away. We just lost the words for it.
...
I am the second kind. I have been the second kind for a long time and I didn't have a clean way to say so.
...
This isn't a tension. It's a cycle. Each direction hands the next one something it couldn't have made on its own.

## The reason I am thinking about this now

I would probably have let this sit as a private theory if it weren't for what has happened in the last couple of years.

When I am orchestrating the Claude SDK, or the OpenAI SDK, or the Vercel AI SDK, I am writing code that would have been filed under back end without much argument. There's no browser in it. But it doesn't feel like systems work. It feels like interface work wearing a mustache and glasses. You are making decisions about what someone will experience, in what order, with what sense of control, and how it should behave when it goes wrong. The old category says one thing and the actual work says another.

That's the clearest sign I have seen that the vocabulary has come loose.

It also seems to explain some of what has happened in this AI era. My honest read is that Anthropic nailed the user experience in a way nobody else did, and Claude Code is the sharpest example of it. I don't think you get there by starting with the capability and looking for somewhere to put it. I think you get there by starting with how someone would actually want to use the thing and working back. Claude Code was built by an engineer, for an engineer. I believe that is why it is the strongest example of a successful AI era product. When the person building it is the person who needs it, there is no gap to close. It was born from fully understanding the user need, and it has spent the past year scaling to realize the promise of its initial theory.

## Both directions win

I want to be careful here, because it would be easy to read this as an argument that one kind of engineer is better. It's not.

My simplified understanding of Apple is that they have almost always worked from the user inward. They haven't necessarily invented the most technology. They adopt it, and then they iterate on the experience until it is theirs. Google looks like the other direction to me. Enormous systems problems nobody had solved, solved well enough that other people could build good interfaces on top of them.
...
Which brings me to the thing I can't stop thinking about. The beta version of Siri, as I understand it, is running on Google's Gemini underneath. We don't know yet how that turns out. But it's a very clean illustration of the point. Apple didn't need to build the model to build the experience. Their bet is that the hard part to copy isn't the model—it's knowing what matters to the person holding the phone and orchestrating the right systems to deliver it.

I wouldn't bet against that, only because it's the thing Apple has historically been best at, in the same way that scalable systems are the thing Google has historically been best at.

## I don't have the words yet

I want to be clear that I'm not proposing terminology here. I don't have it. User driven and systems driven are the closest I've gotten and I'm not satisfied with either one, partly because they both sound like a value judgment and neither is meant to be.

What I'm fairly confident about is that the distinction is there, that it survived the thing that made the old words obsolete, and that we're currently building teams and running interviews with vocabulary that predates most of what we're actually building.
